<template>
  <div class="com-container">
    <!-- <h4 class="text-center">用户特征分析</h4> -->
    <div class="com-chart" ref="UserMark1_ref" id="UserMark1_ref"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      this.chartInstance = this.$echarts.init(this.$refs.UserMark1_ref, "chalk");
      const initOption = {
    ...
    async getData() {
      const that = this;
      await this.$http.get("User1/").then(
        function (response) {
